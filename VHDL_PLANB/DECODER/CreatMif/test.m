...
p=zeros(8,2,3);
p(1,:,:)=[[0,0.4,2];[-0.8,-0.5,0]];
p(2,:,:)=[[0,0.4,2];[-0.8,0.6,0]];
p(3,:,:)=[[0,0.4,2];[0.8,-0.7,0]];
p(4,:,:)=[[0,0.4,2];[0.8,0.8,0]];
p(5,:,:)=[[-0.8,-0.5,0];[-0.8,0.6,0]];
p(6,:,:)=[[-0.8,-0.5,0];[0.8,-0.7,0]];
p(7,:,:)=[[0.8,0.8,0];[-0.8,0.6,0]];
p(8,:,:)=[[0.8,0.8,0];[0.8,-0.7,0]];
